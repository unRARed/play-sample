...
ActiveRecord::Schema[8.0].define(version: 2025_04_10_072305) do
  ...
  create_table "sample_pads", force: :cascade do |t|
    t.string "name"
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_sample_pads_on_user_id"
  end
  ...
  add_foreign_key "sample_pads", "users"
  add_foreign_key "samples", "sample_pads"
end
