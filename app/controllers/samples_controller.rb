  ...
  def play
    ...
    respond_to do |format|
      ...
      format.json { render json: {
        ...
        audio_url: rails_blob_path(@sample.audio, disposition: "inline")
      }}
  ...
  def color_params
    ...
    if params[:sample].is_a?(String)
      begin
        ...
        ActionController::Parameters.new(json_params).permit(:color)
      rescue JSON::ParserError
        # If parsing fails, return empty params
        ActionController::Parameters.new({}).permit(:color)
      end
    else
